"""
Oracle: Full Testnet Deployment Script
...
Handles the complete deployment flow:
  ...
  3. Deploy Oracle validator reference scripts (CIP-33)
...
CONTRACT_DIR = ORACLE_ROOT / "contracts" / "governance-suggestion"
...
def apply_governance_config(config_cbor_hex: str) -> dict:
    """Apply GovernanceConfig to all Oracle validators, return applied blueprint."""
...
async def deploy():
    print("=" * 60)
    print("Oracle: Governance Suggestion Engine — Full Deployment")
    print("=" * 60)
    ...
    if not BLUEPRINT_PATH.exists():
        print("ERROR: Oracle blueprint not found. Run 'aiken build' in contracts/governance-suggestion/")
        return
    ...
    async with VectorAgent(
        ...
        # 4b: Deploy Oracle validator reference scripts
        print("\n  4b. Deploying Oracle validator reference scripts...")
        ref_script_keys = [
