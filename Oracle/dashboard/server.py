"""
Oracle: Foundation Review Dashboard — API Server
...
# Add SDK and Oracle root to path
...
async def startup():
    ...
    if proposal_spend_ref_tx:
        wallet = json.load(open(ORACLE_ROOT / "wallets" / "governance_wallet.json"))
...
app = FastAPI(title="Oracle: Foundation Review Dashboard", lifespan=lifespan)
