...
def test_offline():
    ...
    config = build_governance_config(
        ...
        registry_policy=bytes.fromhex("5dd5118943d5aa7329696181252a6565a27dbf2c6de92b02a6aae361"),
        registry_hash=bytes.fromhex("5dd5118943d5aa7329696181252a6565a27dbf2c6de92b02a6aae361"),
