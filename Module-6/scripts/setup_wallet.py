"""
Module 6: Wallet Setup — Create wallet and fund from Vector faucet.
...
async def create_wallet():
    """Create a new wallet using VectorAgent's HD wallet."""
    import secrets

    # Generate a simple payment key pair using pycardano
...
async def fund_from_faucet(address: str, amount: int = 1000):
    ...
    if not FAUCET_API_KEY:
        print("ERROR: FAUCET_API_KEY not set in .env")
        return
